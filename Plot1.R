...
# identificar Valores ausentes para cada variable

colSums(is.na(x))


## GRAFICAR Frequency Vs Global Active Power (Kilowatts) para los dos dias del mes de 
# febrero del año 2007.

png(filename = "Plot1.png")

hist(as.numeric(x$Global_active_power), xlab = "Global Active Power (Kilowatts)", 
